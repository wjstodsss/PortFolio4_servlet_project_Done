...
<body>
    <div id="wrap">
        <h1 class="text-center">질의 응답 등록</h1>
        <form method="post" action="admin?command=qna_write" enctype="multipart/form-data" name="frm">
            ...
            <div class="form-group row">
                <div class="col-sm-10 offset-sm-2">
                    ...
                    <button type="button" class="btn btn-info" onclick="location.href='admin?command=qna_list'">목록</button>
                </div>
            </div>
        </form>
    </div>
