...
<div id="wrap" class="container">
    <h1 class="text-center">질의응답</h1>
     <div class="text-right">
        <a class="btn btn-success" href="admin?command=qna_write_form">새 글 등록</a>
    ...
    <table class="table">
        ...
        <c:forEach var="board" items="${boardList}">
            <tr>
                ...
                <td><a class="btn btn-primary" href="admin?command=qna_update_form&id=${board.id}">게시글 수정</a></td>
                <td><a class="btn btn-danger" href="admin?command=qna_delete_form&id=${board.id}">게시글 삭제</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
