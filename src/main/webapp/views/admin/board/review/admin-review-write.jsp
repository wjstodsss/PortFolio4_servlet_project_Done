...
<body>
    <div id="wrap">
        <h1 class="text-center">구매후기 등록</h1>
        <form method="post" action="admin?command=review_write" enctype="multipart/form-data" name="frm">
            ...
            <div class="form-group row">
                <div class="col-sm-10 offset-sm-2">
                    ...
                    <button type="button" class="btn btn-info" onclick="location.href='admin?command=review_list'">목록</button>
                </div>
            </div>
        </form>
    </div>
